...
import { Code2, Play, Share2, PanelBottom, Globe, FileCode } from "lucide-react";
        ...
        <div style={{ height: "50px", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 16px", background: "#111", borderBottom: "1px solid var(--border-subtle)" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                {activeUsers.map((name, i) => (
                    <div key={i} title={name} style={{ width: "24px", height: "24px", borderRadius: "50%", background: `hsl(${i * 60}, 70%, 50%)`, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "10px", fontWeight: "bold" }}>{name[0]}</div>
                ))}
